...
1. Lege eine Data Definition (CDS) Z_I_ORDERS_U_XX (Orders View) für die Datenbanktabelle ZCDX_ORDER_00 an. Als Datenbankview sollte der Name ZIORDERSUXX verwendet werden.
